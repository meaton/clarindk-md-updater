...
module.exports = {
    saveMDRecord: function(record, params, query, callback) {
      ...
      var parser = new xml2js.Parser({
          attrkey: parserConfig.attrkey,
          charkey: parserConfig.charkey,
          explicitArray : parserConfig.explicitArray
      });
      ...
      parser.parseString(record, function(err, result) {
            ...
            //app.log.info('result: ' + JSON.stringify(result));
                ...
                reversible: (parserConfig.attrkey === parserDefaults.attrkey && parserConfig.charkey === parserDefaults.charkey && parserConfig.explicitArray === parserDefaults.explicitArray)
		        });
