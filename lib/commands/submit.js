 ...
 *
 */
var utils = require('../utils'), util = utils.util, http = require('http'), parser = require('xml2json');
var submit = module.exports = function(app, queryId, comment) {
   ...
   var updateMDRecordCallback = function(res, res_data, data, record) {
       if(res.statusCode == 200) 
           ...
           app.log.error('Update Failed. Reason: ' + res_data);
	   app.log.debug('Update Failed. Response code: ' + res.statusCode);
